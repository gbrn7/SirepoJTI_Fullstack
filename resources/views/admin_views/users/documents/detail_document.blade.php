...
<div class="breadcrumbs-box mt-1 py-2">
  ...
  <nav style="--bs-breadcrumb-divider: '>'" aria-label="breadcrumb">
    <ol class="breadcrumb m-0">
      ...
      <li class="breadcrumb-item align-items-center">
        <a href="{{route('user-management.document-management.index', $document->user->id)}}"
          class="text-decoration-none">{{$document->user->name}} Document</a>
      </li>
      <li class="breadcrumb-item align-items-center active">Detail Document</li>
    </ol>
  </nav>
</div>
@endsection
