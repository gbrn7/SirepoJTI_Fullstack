...
@section('title', Request::segment(4) === 'create' ? 'Add Document' : 'Edit Document')

@section('custom_css_link', asset('Css/Form_style/main.css'))

@section('breadcrumbs')
<div class="breadcrumbs-box mt-1 py-2">
  <div class="page-title mb-1">{{Request::segment(4) === 'create' ? 'Add Document' : 'Edit
    Document'}}</div>
  <nav style="--bs-breadcrumb-divider: '>'" aria-label="breadcrumb">
    <ol class="breadcrumb m-0">
      ...
      <li class="breadcrumb-item align-items-center active">
        {{Request::segment(4) === 'create' ? 'Add Document' : 'Edit
        Document'}}
      </li>
    </ol>
  </nav>
...
<div class="main-content mt-3">
  <form
    action="{{Request::segment(4) === 'create' ? route('user-management.document-management.store', $user->id) : route('user-management.document-management.update', [$user->id, Request::segment(4)])}}"
